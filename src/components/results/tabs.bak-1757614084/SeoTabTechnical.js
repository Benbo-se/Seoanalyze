  ...
  return (
    <div className="card-grid">
      <div className="info-card">
        ...
        <div className="stats-row">
          <span className="stat-label">Säkerhetspoäng</span>
          <span className={`stat-value ${result.security?.score ? ((result.security.score || 0) >= 70 ? 'score-good' : (result.security.score || 0) >= 50 ? 'score-warning' : 'score-poor') : ''}`}>
            {result.security?.score ? `${result.security.score}/100 (Betyg ${result.security.grade || 'N/A'})` : 'Inte analyserad'}
          </span>
        </div>
        <div className="stats-row">
          <span className="stat-label">Social Media Poäng</span>
          <span className={`stat-value ${result.social?.score ? ((result.social.score || 0) >= 70 ? 'score-good' : (result.social.score || 0) >= 50 ? 'score-warning' : 'score-poor') : ''}`}>
            {result.social?.score ? `${result.social.score}/100 (Betyg ${result.social.grade || 'N/A'})` : 'Inte analyserad'}
          </span>
        </div>
        <div className="stats-row">
      ...
      {result.security && (
        <div className="info-card">
          ...
          <div className="stats-row">
            <span className="stat-label">Totalbetyg</span>

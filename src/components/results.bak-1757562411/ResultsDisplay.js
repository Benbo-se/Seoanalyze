      ...
      <div className="results-container">
        ...
        <nav className="section-nav">
          <div className="nav-container">
            ...
            <a href="#meta" className="nav-link">Meta-taggar</a>
            <a href="#content" className="nav-link">Innehåll</a>
            <a href="#technical" className="nav-link">Tekniskt</a>
            <a href="#recommendations" className="nav-link">Rekommendationer</a>
            {result.schema && (
              <a href="#schema" className="nav-link">
                Schema.org
                <span className="nav-badge">{result.schema.score}</span>
              </a>
            )}
            {result.dns && (
              <a href="#dns" className="nav-link">
                DNS Säkerhet
                <span className="nav-badge">{result.dns.score}</span>
              </a>
            )}
            {result.security && (
              <a href="#security" className="nav-link">
                Säkerhet
                <span className="nav-badge">{result.security.score}</span>
              </a>
            )}
            {result.social && (
              <a href="#social" className="nav-link">
                Social Media
                <span className="nav-badge">{result.social.score}</span>
              </a>
            )}
            {result.readability && (
              <a href="#readability" className="nav-link">
                LIX Läsbarhet
                <span className="nav-badge">{result.readability.seoScore}</span>
              </a>
            )}
          </div>
        </nav>
